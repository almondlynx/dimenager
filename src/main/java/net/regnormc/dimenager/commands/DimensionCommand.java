								...
								.then(CommandManager.argument("identifier", IdentifierArgumentType.identifier())
										.then(CommandManager.argument("type", IdentifierArgumentType.identifier())
												...
												.then(CommandManager.argument("generator", IdentifierArgumentType.identifier())
														...
														.executes(context -> Dimenager.dimensionRepository.importDimension(context.getSource(), IdentifierArgumentType.getIdentifier(context, "identifier"), getDimensionType(context, "type"), IdentifierArgumentType.getIdentifier(context, "type"), getGenerator(context, "generator")))
												)
										)
								)
						)
